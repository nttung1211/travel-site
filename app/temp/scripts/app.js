...
var _ClickToToggle = __webpack_require__(7);
...
new _Navigation2.default('.header a:not(.btn)', '#hero, .page-section');
            ...
            this.sections.forEach(function (section) {
                ...
                new Waypoint({
                    ...
                    handler: function handler(direction) {
                        if (direction === 'down') {
                            var matchingLink = document.querySelector('[href=\'#' + section.id + '\']');
